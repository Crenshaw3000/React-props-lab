...
ReactDOM.render(<TradingCardContainer />, document.querySelector('#tradingCard'));
...
// ReactDOM.render(
//   <TradingCard name="Merge" skill="swimming fast" imgUrl="/static/img/merge.png" />,
//   document.querySelector('#merge'),
// );

// ReactDOM.render(
//   <TradingCard name="Red" skill="good to eat (except for Christina)" imgUrl="/static/img/off-by-one.jpeg" />,
//   document.querySelector('#merge'),
// );